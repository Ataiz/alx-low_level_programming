#include "main.h"
/**
 * copy_prog - A program that will copy the content of a file to another
 * @file_from: The file to copy from
 * @file_to: The file to copy to
*/
void copy_prog(char *file_from, char *file_to)
{
 ...
 * @av: The argumemt vectors (array of pointers)
